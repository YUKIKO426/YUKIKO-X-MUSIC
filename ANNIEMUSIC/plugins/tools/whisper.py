    ...
    if len(data.split()) < 2:
        mm = [
            InlineQueryResultArticle(
                ...
                thumb_url="https://telegra.ph/file/1b4be775a70289674b3ef.jpg",
...
async def in_help():
    answers = [
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent(f"**❍ Usage:**\n\n@Yukiko_Musix_Bot (Target Username or ID) (Your Message).\n\n**Example:**\n@Yukiko_Musix_Bot @username I Wanna Phuck You"),
            thumb_url="https://telegra.ph/file/1b4be775a70289674b3ef.jpg",
            reply_markup=switch_btn
        )
    ]
