...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Godxorion1")
BOT_USERNAME = getenv("BOT_USERNAME", "RESHUXMUSIC_BOT")
BOT_NAME = getenv("BOT_NAME", "RESHU X MUSIC")
ASSUSERNAME = getenv("ASSUSERNAME", "RESHHUXASSISTENT")
EVALOP = list(map(int, getenv("EVALOP", "6797202080").split()))
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
LOGGER_ID = int(getenv("LOGGER_ID", -1002160100170))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Devil372/PENGUIN-X-MUSIC")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# Support and contact information - Provide your own support channels
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/icc_x_SUPPORT")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/icc_x_CHAT")
